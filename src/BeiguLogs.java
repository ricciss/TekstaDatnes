...
public class BeiguLogs extends JFrame {
	...
	public BeiguLogs(int finalScore, int correctCount, int incorrectCount,
		...
		URL javaLogoImageUrl = getClass().getResource("javaLogo.png");
		if (javaLogoImageUrl != null) {
		    setIconImage(new ImageIcon(javaLogoImageUrl).getImage());
		} else {
		    System.out.println("Brīdinājums: Attēls 'javaLogo.png' nav atrasts kā resurss 'BeiguLogs'.");
		...
		for (int i = 0; i < allQuestionTexts.size(); i++) {
		   ...
		   String optionA = (i < allOptionAs.size()) ? allOptionAs.get(i) : "N/A";
		   String optionB = (i < allOptionBs.size()) ? allOptionBs.get(i) : "N/A";
		   String optionC = (i < allOptionCs.size()) ? allOptionCs.get(i) : "N/A";
		   String optionD = (i < allOptionDs.size()) ? allOptionDs.get(i) : "N/A";
		   
		   String userAnswerLetter = (i < allUserAnswers.size()) ? allUserAnswers.get(i) : "N/A";
		   String correctAnswerLetter = (i < allCorrectAnswers.size()) ? allCorrectAnswers.get(i) : "N/A";

		   String status = "N/A";
		 

		   if (!userAnswerLetter.equals("N/A") && !correctAnswerLetter.equals("N/A")) {
		...
		JButton backButton = new JButton("Beigt");
